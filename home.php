...
<section>
    <div class="container home_states text-center">
          ...
          <div class="row">
                <div class="col-md-4">
                    <div class="stat st-member">المنظمات
                    <span><a href="bussniss.php"><?php echo getCountOrg("bussniss");?></a></span>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="stat st-proj">المشاريع
                    <span><a href="mang_project.php"><?php echo getCountOrg("projects");?></a></span>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="stat st-pending">المستخدمين
                    <span><?php echo getCountOrg("users");?></span>
                    </div>
                </div>
          </div>
         </div> 
