...
<section>
    <div class="container home_states text-center">
          ...
          <div class="row">
                ...
                <div class="col-md-2">
                    <div class="stat">عدد المستخدمين المضاف حديثاً
                    <span>200</span>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="stat">عدد المنظمات
                    <span>200</span>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="stat">عدد المنظمات المضافة حديثاً
                    <span>200</span>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="stat">عدد المشاريع
                    <span>200</span>
                    </div>
                </div>
                <div class="col-md-2">
                <div class="stat">عدد المشاريع المضافة حديثاً
                    <span>200</span>
                </div>
            </div>
          </div>
