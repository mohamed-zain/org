...
<section>
    <div class="container home_states text-center">
          <h1>احصائيات ذات علاقة بالمنظمات</h1>
          <div class="row">
                <div class="col-md-4">
                    <div class="stat st-member">عدد المنظمات
                    <span><a href="bussniss.php"><?php echo getCountOrg("bussniss");?></a></span>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="stat st-proj">عدد المنظمات المشاركة فى المشاريع
                    <span><?php echo getCountOrg("bussniss where isShare_project=1");?></a></span>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="stat st-pending">عدد المنظمات المضافة حديثاً
                    <span><?php echo getCountOrg("bussniss where isActive!=1");?></span>
                    </div>
                </div>
          </div>
    </div>
    ...
    <div class="row">
      <div class="col-sm-6">
         <div class="panel panel-default">
             ...
             <?php $num =3;?>
                <i class="fa fa-users"></i>اخر <?php echo $num;?> منظمات مضافة حديثاً
             </div>
             <div class="panel-body">
             <?php 
                $q = getLatest('bussniss',$num,"id");
