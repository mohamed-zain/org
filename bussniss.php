...
$org = mysql_query("select * from bussniss")or die(mysql_error());
...
<?php if(!empty($message)){
                    ...
                    while($row = mysql_fetch_array($org)){
                        echo'<tr>
                                 ...
                                 <td>'.$row['register_date'].'</td>
                                  <td>
                                      <a href="edit_buss.php?do=Edit&id='.$row['id'].'" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> تعديل</a></td>
                                    <td><a class="btn btn-danger btn-sm delete " id="'.$row['id'].'"><i class="fa fa-close"></i> حذف</a>
                                  </td>';
                            if($row['isActive'] == 0)
                              $act = "غير نشط";
                            if($row['isActive'] == 1)      
 ...
 <a href="add_org.php" class="btn btn-primary"><i class="fa fa-plus"></i> اضافة منظمة</a>
        </div>
