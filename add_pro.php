...
if(isset($_POST['submit'])){
    $username = $_POST['projectname'];
    $address = $_POST['Description'];
    $email = $_POST['t1'];
    $pass = $_POST['t2'];
    //$star_date = $_POST['star_date'];
    $q = mysql_query("insert into projects values('','$username','$address','$email','$pass','')")or die(mysql_error());
    if(isset($q))
    {
...
<section>
    ...
    <h1 class="text-center">اضافة مشروع جديد</h1>
    <div class="container">
          <form class="form-horizontal" method="post" action="add_pro.php">
              <div class="form-group">
                   <label class="col-md-2 control-lable">اسم المشروع </label>
                   <div class="col-sm-10">
                       <input type="text" placeholder="ادخل اسم المشروع" name="projectname" class="form-control">
                  </div>
              </div>
              <div class="form-group">
                 <label class="col-sm-2 control-lable">الوصف</label>
                 <div class="col-sm-10">
                     <textarea name="Description" id="message" required="required" class="form-control" rows="4" placeholder="ادخل الوصف"></textarea>
                </div>
              </div>    
              <div class="form-group">
                   <label class="col-sm-2 control-lable">تاريخ البداية </label>
                   <div class="col-sm-10">
                       <input type="text" id="datepick" placeholder="ادخل تاريخ البداية" name="t1" class="form-control">
                  </div>
              </div>
              <div class="form-group">
                   <label class="col-sm-2 control-lable">تاريخ النهاية </label>
                   <div class="col-sm-10">
                       <input type="text" id="datepick2" placeholder="ادخل تاريخ النهاية" name="t2" class="form-control">
                  </div>
              </div>
              <div class="form-group">
